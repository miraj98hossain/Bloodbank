    ...
    <nav class="navbar navbar-expand-lg">
      <ul class="navbar-nav ">
        <li class="navbar-item ">
          ...
          <a href="Requestblood.php"><button class="custom-btn btn-7">Request Blood</button></a>
          <a href="DonateBlood.php"><button class="custom-btn btn-7">Donate Blood</button></a>
          <a href="Faqs.php"><button class="custom-btn btn-7">Faqs</button></a>
